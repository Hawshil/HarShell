...
1. Searching the PATH environment variable for the executable
2. Forking a child process
3. Using `execve()` to replace the child process with the target program
4. Waiting for child process completion
